            ...
            <div class="lg:col-span-2">
                <div class="card bg-base-100 shadow-xl">
                    <div class="card-body">
                        ...
                        <div class="form-control w-full mb-4">
                            ...
                            <select name="menu_location" class="select select-bordered w-full @error('menu_location') select-error @enderror" required>
                                ...
                                @foreach($menuLocations as $value => $label)
                                    <option value="{{ $value }}" {{ old('menu_location', request('location')) == $value ? 'selected' : '' }}>
                                        {{ $label }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-control w-full mb-4" id="page-select" style="{{ old('type', 'page') != 'page' ? 'display:none' : '' }}">
                            <label class="label">
                        ...
                        <div class="form-control w-full mb-4" id="url-input" style="{{ old('type', 'page') == 'page' ? 'display:none' : '' }}">
                            <label class="label">
                    ...
                    <div class="card-body">
                        ...
                        <div class="form-control w-full mb-4">
                            <label class="label">
                                ...
                                <span class="label-text-alt">Leave blank for auto</span>
                            </label>
