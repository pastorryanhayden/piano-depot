...
@section('title', 'Edit Piano Category')
...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold">Edit Piano Category: {{ $pianoCategory->name }}</h1>
    ...
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.piano-categories.update', $pianoCategory) }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-control">
                        ...
                        <input type="text" 
                               name="name" 
                               value="{{ old('name', $pianoCategory->name) }}" 
                    ...
                    <div class="form-control">
                        ...
                        <input type="text" 
                               name="slug" 
                               value="{{ old('slug', $pianoCategory->slug) }}" 
                ...
                <div class="form-control">
                    ...
                    <textarea name="description" 
                              ...
                              placeholder="Brief description of this category...">{{ old('description', $pianoCategory->description) }}</textarea>
                    @error('description')
                        <label class="label">
                            <span class="label-text-alt text-red-500">{{ $message }}</span>
                        </label>
                ...
                <div class="form-control">
                    ...
                    <div class="editor-container">
                        ...
                        <div id="editor" class="editor-content" contenteditable="true">{!! old('content', $pianoCategory->content) ?: '<p>Start writing your category content here...</p>' !!}</div>
                    </div>
                    <input type="hidden" name="content" id="content-input" value="{{ old('content', $pianoCategory->content) }}">
                    @error('content')
                        <label class="label">
                            <span class="label-text-alt text-red-500">{{ $message }}</span>
                        </label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="form-control">
                        ...
                        @if($pianoCategory->featured_image)
                            <div class="mb-4">
                                <img src="{{ asset('storage/' . $pianoCategory->featured_image) }}" 
                                     alt="{{ $pianoCategory->name }}" 
                    ...
                    <div class="form-control">
                        ...
                        <input type="number" 
                               name="sort_order" 
                               value="{{ old('sort_order', $pianoCategory->sort_order) }}" 
                    ...
                    <div class="form-control">
                        <label class="label cursor-pointer justify-start">
                            ...
                            <input type="checkbox" 
                                   ...
                                   {{ old('show_prices', $pianoCategory->show_prices) ? 'checked' : '' }}>
                            <div>
                    ...
                    <div class="form-control">
                        <label class="label cursor-pointer justify-start">
                            ...
                            <input type="checkbox" 
                                   ...
                                   value="1"
                                   class="checkbox checkbox-primary mr-3" 
                                   {{ old('is_active', $pianoCategory->is_active) ? 'checked' : '' }}>
                            <div>
