...
<div class="container mx-auto px-4 sm:px-6 lg:px-8 py-8">
    <div class="flex justify-between items-center mb-6">
        <h1 class="text-3xl font-bold">Add New Piano</h1>
    ...
    <div class="card bg-base-100 shadow-xl">
        <div class="card-body">
            <form method="POST" action="{{ route('admin.pianos.store') }}" enctype="multipart/form-data" class="space-y-6">
                @csrf
                ...
                <div class="form-control">
                    ...
                    <textarea name="description" 
                              ...
                              placeholder="Enter detailed description of the piano...">{{ old('description') }}</textarea>
                    @error('description')
                        <label class="label">
                            <span class="label-text-alt text-red-500">{{ $message }}</span>
                        </label>
